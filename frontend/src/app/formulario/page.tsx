...
const formScheme: FormProps = { name: "", font: "", file: ""}
            ...
            <section className='flex flex-col items-center justify-center my-5'>
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <div className='mt-5 grid grid-cols-1'>
                        <label className='block text-sm font-medium leading-6 text-gray-700'>Fonte: *</label>
                        <InputText id="font" onChange={formik.handleChange} placeholder="fonte ou autor da imagem" />
                    </div>
                    <div className='mt-5 grid grid-cols-1'>
